...
gen laggedAgrSurface = L.AgrSurface
...
qui: eststo: xtreg `VVV' lagged_Rev_PC lagged_2_Rev_PC lagged_3_Rev_PC i.year gpscore laggedAVGWindDensity laggedAgrSurface laggedUnemplyRate lagged_Turbines, vce(cluster MUN_ID)
