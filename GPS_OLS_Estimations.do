...
// ===========================================================
// ============== 	Estimation with GPS Adjustment	==========
// ===========================================================
*--------------------------------------
...
esttab using "Output\Incomes.tex", keep(lagged_Rev_PC lagged_2_Rev_PC lagged_3_Rev_PC gpscore) booktabs ///
...
title(Effect of Wind Power Deployment on the Personal Income - GPS Covariate Adjustment \label{incomeresults}) ///
...
esttab using "Output\Budgets_Total.tex", keep(lagged_Rev_PC lagged_2_Rev_PC lagged_3_Rev_PC gpscore) booktabs ///
varlabels(lagged_Rev_PC "\addlinespace \makecell{L.Revenue \\ per capita}" lagged_2_Rev_PC "\makecell{L(2).Revenue \\ per capita}" lagged_3_Rev_PC "\makecell{L(3).Revenue \\ per capita}" gpscore "GPS", elist(L.New_Rev_PC "\addlinespace" L2.New_Rev_PC "\addlinespace" L3.New_Rev_PC "\addlinespace" gpscore "\addlinespace" )) ///
...
stat(YFE N, labels("\addlinespace Year FE" "\addlinespace \midrule \addlinespace Observations" "Adj. R-squared")) ///
p star(* 0.1 ** 0.05 *** 0.01) ///
title(Effect of Wind Power Deployment on the Municipal Budget - GPS Covariate Adjustment \label{budgetresults}) ///
nomtitle nonumbers nonotes nogaps ///
note(p-values in parentheses, $^{*}\, p<0.1$, $^{**}\, p<0.05$, $^{***}\, p<0.01$) width(\hsize) replace
...
esttab using "Output\Employment_detailed1.tex", keep(lagged_Rev_PC lagged_2_Rev_PC lagged_3_Rev_PC gpscore) booktabs ///
varlabels(lagged_Rev_PC "\addlinespace \makecell{L.Revenue \\ per capita}" lagged_2_Rev_PC "\makecell{L(2).Revenue \\ per capita}" lagged_3_Rev_PC "\makecell{L(3).Revenue \\ per capita}" gpscore "GPS", elist(L.New_Rev_PC "\addlinespace" L2.New_Rev_PC "\addlinespace" L3.New_Rev_PC "\addlinespace" gpscore "\addlinespace" )) ///
...
stat(YFE N, labels("\addlinespace Year FE" "\addlinespace \midrule \addlinespace Observations" "Adj. R-squared")) ///
p star(* 0.1 ** 0.05 *** 0.01) ///
title(Effect of Wind Power Deployment on Employment - GPS Covariate Adjustment \label{employmentresults}) ///
nomtitle nonumbers nonotes nogaps ///
note(p-values in parentheses, $^{*}\, p<0.1$, $^{**}\, p<0.05$, $^{***}\, p<0.01$) width(\hsize) replace
...
esttab using "Output\Employment_detailed2.tex", keep(lagged_Rev_PC lagged_2_Rev_PC lagged_3_Rev_PC gpscore) booktabs ///
varlabels(lagged_Rev_PC "\addlinespace \makecell{L.Revenue \\ per capita}" lagged_2_Rev_PC "\makecell{L(2).Revenue \\ per capita}" lagged_3_Rev_PC "\makecell{L(3).Revenue \\ per capita}" gpscore "GPS", elist(L.New_Rev_PC "\addlinespace" L2.New_Rev_PC "\addlinespace" L3.New_Rev_PC "\addlinespace" gpscore "\addlinespace" )) ///
...
esttab using "Output\Employment_detailed3.tex", keep(lagged_Rev_PC lagged_2_Rev_PC lagged_3_Rev_PC gpscore) booktabs ///
varlabels(lagged_Rev_PC "\addlinespace \makecell{L.Revenue \\ per capita}" lagged_2_Rev_PC "\makecell{L(2).Revenue \\ per capita}" lagged_3_Rev_PC "\makecell{L(3).Revenue \\ per capita}" gpscore "GPS", elist(L.New_Rev_PC "\addlinespace" L2.New_Rev_PC "\addlinespace" L3.New_Rev_PC "\addlinespace" gpscore "\addlinespace" )) ///
...
esttab using "Output\Employment_detailed4.tex", keep(lagged_Rev_PC lagged_2_Rev_PC lagged_3_Rev_PC gpscore) booktabs ///
varlabels(lagged_Rev_PC "\addlinespace \makecell{L.Revenue \\ per capita}" lagged_2_Rev_PC "\makecell{L(2).Revenue \\ per capita}" lagged_3_Rev_PC "\makecell{L(3).Revenue \\ per capita}" gpscore "GPS", elist(L.New_Rev_PC "\addlinespace" L2.New_Rev_PC "\addlinespace" L3.New_Rev_PC "\addlinespace" gpscore "\addlinespace" )) ///
...
stat(YFE N, labels("\addlinespace Year FE" "\addlinespace \midrule \addlinespace Observations" "Adj. R-squared")) ///
p star(* 0.1 ** 0.05 *** 0.01) ///
title(Effect of Wind Power Deployment on Employment - GPS Covariate Adjustment \label{employmentresults4}) ///
nomtitle nonumbers nonotes nogaps ///
note(p-values in parentheses, $^{*}\, p<0.1$, $^{**}\, p<0.05$, $^{***}\, p<0.01$) width(\hsize) replace
eststo clear